         ...
         <section class="text-white-100 body-font">
              <div class="container px-5 py-10 mx-auto">
                ...
                <div class="flex flex-wrap -m-4 text-center">
                  <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                    <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                      <BsWindows className='docs__smartphones-icons text-indigo-500 ' style={{ fontSize: 60 }} />
                      <p class="leading-relaxed">Windows</p>
                    </div>
                  </div>
                  <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                    <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                    <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                      <TvIcon className='text-indigo-500 ' style={{ fontSize: 60 }} />
                      <p class="leading-relaxed">Linux</p>
                    </div>
                  </div>
                  <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                    <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                      <TvIcon className='text-indigo-500 ' style={{ fontSize: 60 }} />
                      <p class="leading-relaxed">Mac</p>
                    </div>
                  </div>
                  <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                    <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                      <TvIcon className='text-indigo-500 ' style={{ fontSize: 60 }} />
                      <p class="leading-relaxed">Windows phone</p>
                    </div>
                  </div>
                </div>
              </div>
