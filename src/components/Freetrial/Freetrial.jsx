...
const Freetrial = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_ci7h285', 'template_x91h5i9', form.current, 'h35vyNm11SpNFIkaU')
      .then((result) => {
  ...
  return (
    <form ref={form} onSubmit={sendEmail} className=" freetrial text-gray-400 body-font">
           <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
                  ...
                  <div class="relative mb-4">
                      ...
                      <input type="text" id="name" name="name" class="w-full bg-gray-600 bg-opacity-20 focus:bg-transparent focus:ring-2 focus:ring-purple-900 rounded border border-gray-600 focus:border-purple-500 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
                  </div>
                  <div class="relative mb-4">
