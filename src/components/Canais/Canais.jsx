...
const Canais = () => {
  return (
    <div className='talk-hub__technology' id='canais'>

            <div className='talk-hub__technology-content'>
                <h4>+80 Mil Conteúdos</h4>

                <h1 className='gradient__text-canais'> Oferecemos todos os Canais Abertos e Fechados, sem travamentos e em ótimas qualidades.</h1>
                ...
                <h4><a href="#vantagens">Continuar lendo</a></h4>
            </div>
