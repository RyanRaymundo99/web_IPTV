            ...
            <section class="text-white-100 body-font">
              <div class="container px-5 py-5 mx-auto">
                <div class="flex flex-col text-center w-full mb-10">
                  <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Compatible with Smart TVs</h1>
                </div>
        ...
        <div class=" p-10 bg-white dark:bg-white" id='others'>
         <section class="text-white-100 body-font">
              <div class="container px-5 py-10 mx-auto">
                <div class="flex flex-col text-center w-full mb-10">
                  <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Compatible with PCs & Smartphones</h1>
                </div>
                <div class="flex flex-wrap -m-4 text-center">
                  <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
