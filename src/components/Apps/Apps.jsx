    ...
    <div className='apps'>
        <section class="text-gray-400 body-font">
            <div class="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
                ...
                <img className="object-cover object-center rounded app-logo" alt="hero" src="https://www.ottrun.com/assets/img/logo.png"/>
                </div>
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">Teste nosso aplicativo</h1>
                <p class="mb-8 leading-relaxed">A Cine Tv oferece um aplicativo totalmente exclusivo para você. Basta baixa-lo e assistir tudo o que quiser e quando quiser. tenha todos os tipos de Series Filmes e ainda acesso a Tv aberta.</p>
